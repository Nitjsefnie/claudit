...
End-to-end correctness check: session-viz's per-session aggregates vs. the
...
| field | session-viz | canonical | Δ | Δ % |
|---|---|---|---|---|
...
agent transcripts as part of the global walk while session-viz drops them.
